 ...
 *   2. ingest Layer 1 signals for every seeded entity (all fetchers, incl.
 ...
 * made here — Stage 2/3 stay behind the explicit /api/alerts/* endpoints so
 * spend remains a deliberate action. Run /api/dashboard/snapshot afterwards to
 * push the result into the frontend's data.json.
 */
